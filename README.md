...
| ---------------------------------------------------- | -------------------------------------- | ------------------------------------------- | ------- | ----------------------------------- | ------- |
| [Ego-R1: Chain-of-Tool-Thought for Ultra-Long Egocentric Video Reasoning](https://arxiv.org/abs/2506.13654) | - | - | - | - | 2025.06.16 |
| [MiniMax-M1: Scaling Test-Time Compute Efficiently with Lightning
  Attention](https://arxiv.org/abs/2506.13585) | [MiniMax-AI/MiniMax-M1.](https://github.com/MiniMax-AI/MiniMax-M1.) | - | - | - | 2025.06.16 |
